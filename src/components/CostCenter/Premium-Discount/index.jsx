...
const PremiumDiscountCenter = () => {
  ...
  const fetchPremiumDiscountData = useCallback(async () => {
    setError(null);
    setLoading(true);
    ...
    try {
      ...
      // Normalize dates to date-only format (e.g., '2025-07-01')
      if (startDate) {
      ...
      setError("Failed to fetch premium discount data: " + err.message);
  ...
  const handleSoftDelete = async (id) => {
    if (
      !window.confirm(
        "Are you sure you want to delete this premium discount transaction?"
      )
    ) {
      return;
    }
    ...
    try {
      ...
      setError("Failed to delete premium discount transaction");
  ...
  const getColorFilter = (colorClass) => {
    switch (colorClass) {
      case "text-red-700":
        return "invert(20%) sepia(94%) saturate(2000%) hue-rotate(350deg) brightness(85%) contrast(110%)"; // #b7271d
      case "text-green-700":
        return "invert(48%) sepia(61%) saturate(512%) hue-rotate(90deg) brightness(93%) contrast(85%)";
      case "text-blue-900":
        return "invert(24%) sepia(80%) saturate(900%) hue-rotate(180deg) brightness(90%) contrast(100%)"; // deep blue
      case "text-gray-900":
      default:
        return "invert(0%)"; // black
    }
  };
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100">
                Monitor and manage premium discount transactions and balance
                entries
              </p>
            </div>
            ...
            <div className="p-6 border-b border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search premium discount transactions..."
                    value={searchTerm}
            ...
            {loading && (
              <div className="flex items-center justify-center py-12">
                ...
                <span className="text-gray-600">
                  Loading premium discount transactions...
                </span>
              </div>
            )}
                ...
                {!loading && transactionsWithBalance.length === 0 && (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500">
                      No premium discount transactions found matching your
                      criteria.
                    </p>
                  </div>
                )}
...
export default PremiumDiscountCenter;