...
const VatCenter = () => {
  ...
  const handleSoftDelete = async (id) => {
    if (
      !window.confirm("Are you sure you want to delete this VAT transaction?")
    ) {
      return;
    }
    ...
    try {
      ...
      setError("Failed to delete VAT transaction");
      ...
      <div className="mb-8">
        <div className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-xl p-6 shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold mb-2">VAT Management</h1>
              <p className="text-orange-100">
                Monitor and manage VAT transactions and balance entries
              </p>
            </div>
              ...
              <div className="p-6">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">VAT Transactions</p>
                  </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl">
            ...
            {loading && (
              <div className="flex items-center justify-center py-12">
                ...
                <span className="text-gray-600">Loading VAT transactions...</span>
              </div>
            )}
                ...
                {!loading && transactionsWithBalance.length === 0 && (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500">
                      No VAT transactions found matching your criteria.
                    </p>
                  </div>
                )}
              </div>
