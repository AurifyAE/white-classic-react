...
import { X, ShoppingCart, Wallet, Trash2, Activity } from "lucide-react";
import { formatters, DEFAULT_CONFIG } from "../../utils/currencyUtils";
...
const TradeModal = ({
  ...
  if (!showTradingModal || !selectedPair || !currencies[selectedPair] || !modalSelectedParty) {
    return null;
  }
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
            ...
            <select
              ...
              onChange={(e) =>
                setModalSelectedParty(parties.find((p) => p.id === e.target.value))
              }
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      step={selectedPair === DEFAULT_CONFIG.GOLD_SYMBOL ? "0.001" : "0.01"}
                      min="0"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      type="number"
                      value={buyAmount && dynamicBuyRate > 0 ? (buyAmount * dynamicBuyRate) : ""}
                      onChange={(e) => {
                  ...
                  <button
                    onClick={() =>
                      executeTrade("buy", selectedPair, dynamicBuyRate, buyAmount, modalSelectedParty)
                    }
              ...
              <div className="bg-red-50 p-4 rounded-xl border border-red-200">
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={sellAmount && dynamicSellRate > 0 ? (parseFloat(sellAmount) * dynamicSellRate).toFixed(2) : ""}
                      onChange={(e) => {
                  ...
                  <button
                    onClick={() =>
                      executeTrade("sell", selectedPair, dynamicSellRate, sellAmount, modalSelectedParty)
                    }
