      ...
      const purchaseTransactions = uniqueTransactions
        ...
        .map((transaction, index) => {
          ...
          return {
            ...
            vocType: transaction.voucherType || "PR",
  ...
  const generateVoucherNumber = useCallback(async () => {
    try {
      ...
      return {
        ...
        voucherType: data.voucherType || "PR",
        prefix: data.prefix,
      };
    } catch (error) {
...
const handleDownloadPDF = async (purchaseId) => {
  ...
  const handleExportAllToPDF = async () => {
    ...
    try {
      ...
      // Save PDF
      doc.save("filtered-metal-purchases-return.pdf");
      toast.success(
        "Filtered purchase return transactions exported to PDF successfully!"
      );
    } catch (error) {
      console.error("Error generating PDF:", error);
  ...
  const handleAdd = useCallback(async () => {
    ...
    setIsModalOpen(true);
    toast.success(" new purchase return Metal", {
      style: {
        background: "white",
        color: "green",
  ...
  async (stock) => {
    ...
    try {
      ...
      setFormData({
        ...
        voucherType: transaction.voucherType || "PR",
        prefix: transaction.prefix || "PR",
  ...
  const confirmDeletePurchase = useCallback(async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        showToast("Metal purchase return deleted successfully", "success");
            ...
            <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-100">
              <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
                ...
                <p className="text-sm text-gray-600 mb-6">
                  Are you sure you want to delete this metal purchase return? This
