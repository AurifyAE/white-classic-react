                    ...
                    {orders.length > 0 ? (
                      orders.map((order) => (
                        ...
                        >
                          ...
                          <td className="py-3 px-4 whitespace-nowrap text-right">
                            AED {formatCurrency(order.price)}
                          </td>
                          ...
                          <td className="py-3 px-4 whitespace-nowrap text-center">
                            <div className="flex items-center justify-center gap-2">
                              <button
                                ...
                                className="bg-red-100 text-red-600 px-3 py-1 rounded hover:bg-red-200 text-xs font-medium transition-colors flex items-center gap-1"
                              >
                                <Trash2 size={14} />
                                Delete
                              </button>
