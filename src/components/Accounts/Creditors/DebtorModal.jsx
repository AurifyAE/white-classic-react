...
const Header = ({ searchTerm, setSearchTerm, handleAdd }) => (
  <div className="mb-6">
    <div className="flex justify-between items-center">
      <h1 className="text-2xl font-bold text-gray-800">Trade Creditors</h1>
...
const BasicInfoHeader = ({
  ...
  const [selectedType, setSelectedType] = useState(
    basicFormData.type || "CREDITOR"
  );

  const handleTypeChange = (type) => {
    setSelectedType(type);
    setBasicFormData({ ...basicFormData, type }); // Update basicFormData.type
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white"
            disabled={selectedType !== "CREDITOR"}
          >
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">
            {selectedType === "CREDITOR" ? "Party Name" : "Group Name"}
          </label>
          <input
            type="text"
...
const AcDefinitionTab = ({
  ...
  useEffect(() => {
    if (
      acDefinitionData.currency.currency == "" &&
  ...
  const handleDefaultCurrencyChange = (newDefaultCurrency) => {
    ...
    toast.warning(
      `You have already ${defaultCurrency} set as default currency. Do you need to change it to ${newDefaultCurrency}?`,
      {
        action: {
          label: "Yes, Change",
          onClick: () => {
            ...
            const selectedCurrencyObj = currencyOptions.find(
              (c) => c.currency === newDefaultCurrency
            );
        ...
        cancel: {
          ...
          className:
            "px-4 py-2 bg-gray-200 text-gray-800 rounded-xl hover:bg-gray-300 transition-colors",
        },
  ...
  // Ensure AED is always in the checked currencies and set as default
  useEffect(() => {
    if (currencyOptions.length > 0 && !checkedCurrencies.includes("AED")) {
      setCheckedCurrencies((prev) => ["AED", ...prev]);
    }
  }, [currencyOptions]);
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold">
                  {editingDebtor ? "Add Trade Creditor" : "Add Trade Creditor"}
                </h2>
