      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
        ...
        <div className="p-6 space-y-4">
          <InputField
            ...
            onChange={(e) => setEmployeeForm(prev => ({ ...prev, name: e.target.value.toUpperCase() }))}
            required
          ...
          <InputField
            ...
            onChange={(e) => setEmployeeForm(prev => ({ ...prev, designation: e.target.value.toUpperCase() }))}
          ...
          <InputField
            ...
            onChange={(e) => setEmployeeForm(prev => ({ ...prev, email: e.target.value.toUpperCase()}))}
            required
          ...
          <InputField
            ...
            onChange={(e) => setEmployeeForm(prev => ({ ...prev, mobile: e.target.value.toUpperCase() }))}
